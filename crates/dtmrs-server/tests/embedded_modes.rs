...
fn tmp_db(name: &str) -> (String, std::path::PathBuf) {
    let p = std::env::temp_dir().join(format!("dtmrs_modes_{}_{}.db", name, std::process::id()));
